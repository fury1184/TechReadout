...
CREATE TABLE IF NOT EXISTS inventory (
    ...
    -- Status
    status ENUM('Unverified','Verified','Installed','Missing','Sold','Dead') NOT NULL DEFAULT 'Unverified',
    ...
    -- eBay price estimate flag (v3.1.0)
    price_is_estimate TINYINT(1) NOT NULL DEFAULT 0,
...
-- Price cache for eBay API results (v3.1.0, 24-hour TTL)
...
-- Pending reviews: scrape/Open WebUI matches below the auto-accept confidence threshold
CREATE TABLE IF NOT EXISTS pending_reviews (
    ...
    FOREIGN KEY (resolved_spec_id) REFERENCES hardware_specs(id)
);
